namespace L11_FlowerMeadow_Advanced {
    ...
    function nectarLvlSunFlower(): void { //w3schools
        // console.log("nectar");

        if (i == 0) {
            i = 1;
            let bar: HTMLElement = <HTMLElement>document.getElementById("nectarSunflower");
            let width: number = 1;
            let id: number = setInterval(frame, 100);
    ...
    function nectraLvlPinkFlower(): void { //w3schools
        // console.log("nectar");

        if (i == 0) {
            i = 1;
            let bar: HTMLElement = <HTMLElement>document.getElementById("nectarPinkFlower");
            let width: number = 1;
            let id: number = setInterval(frame, 100);
    ...
    function nectraLvlBlueFlower(): void { //w3schools
        // console.log("nectar");

        if (i == 0) {
            i = 1;
            let bar: HTMLElement = <HTMLElement>document.getElementById("nectarBlueFlower");
            let width: number = 1;
            let id: number = setInterval(frame, 100);
